...
<div  style="background:url(<?php echo e(URL::asset('upload/newsletter.png')); ?>) no-repeat; width:800px; height:1000px; margin:0 auto; padding:100px 50px 0 50px; box-sizing:border-box;">
    <div style="height:720px; width:440px; margin:40px auto;">
            ...
            <div style="padding:0 30px; border-bottom:1px solid #0096d6;">
                <p style="font-weight:bold; color:#0096d6;font-size:16px; margin-bottom:20px;">Hi <?php echo $first_name ;?> <?php echo $last_name; ?></p>
               
                <aside style="margin-top:30px; line-height:25px;"> <!--
                    <p style="font-weight:bold; color:#0096d6;font-size:16px;"> -->
					<p>Thanks a lot to sign up at PEO Connection RFPS.</p>
                      
					<p>We are glad to welcome you to our Lead Generation Software.</p>
					<p>Once our admin approves your account, you will be able to log into your account.</p>

					<p>Login Here: http://rfps.glocify.org/</p>

					<p>If you face any issues with our system, You can contact our support using the link here: http://rfps.glocify.org/support</p>
                    <p> 
					Thanks
                   </p><!--
