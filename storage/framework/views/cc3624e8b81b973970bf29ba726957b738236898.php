                            ...
                            <div class="block">
                                <div class="block-content tab-content">
                                 ...
                                 <?php if(Session::has('flash_message')): ?>
									...
									<?php echo Form::open(array('url' => array('admin/rates/import_rates'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')); ?>
									...
									<?php echo Form::open(array('url' => array('admin/all-rates'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','method'=>'GET')); ?>

									 <div class="col-lg-1"><h6>Search Code</h6></div><div class="col-lg-3"><input type="text" name="search" value="<?php echo e($search); ?>"> </div>
											...
											<tbody>
											  <?php $i = 1;?>
												<?php foreach($rates as $rate): ?>
													<tr>
														<td><?php echo e($rate->Index_code); ?></td>
														<td><?php echo e($rate->State); ?></td>
														<td><?php echo e($rate->Code); ?></td>
														<td><?php echo e($rate->TWC); ?></td>
														<td><?php echo e($rate->WWC); ?></td>
														
														<td><a href="<?php echo e(url('admin/rates', ['id' => $rate->id])); ?>">Update</a></td> 
														<td><a onclick="return confirm('Are you sure?')" href="<?php echo e(url('admin/rates/delete', ['id' => $rate->id])); ?>">Delete</a></td>
														<td><a href="<?php echo e(url('admin/viewrate', ['id' => $rate->id])); ?>">View</a></td> 
