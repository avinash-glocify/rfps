<?php $__env->startSection("content"); ?>
 ...
 <!-- Page Header -->
	...
	<div class="row" >
			...
			<div class="col-md-6">
			<?php echo e(Form::label('index', 'Index')); ?>

			</div>
			<div class="col-md-6">
				<?php echo e(Form::label('index', $rate->Index_code)); ?>
			...
			<div class="col-md-6">
				<?php echo e(Form::label('State', $rate->State)); ?>
			...
			<div class="col-md-6">
				<?php echo e(Form::label('Code', $rate->Code)); ?>

			</div>
			</div>
			<div class="form-group">
			<div class="col-md-6">
			<?php echo e(Form::label('TWC', 'TWC')); ?>

			</div>
			<div class="col-md-6">
				<?php echo e(Form::label('TWC', $rate->TWC)); ?>
			...
			<div class="form-group">
			<div class="col-md-6">
			<?php echo e(Form::label('RWC', 'RWC')); ?>

			</div>
			<div class="col-md-6">
				<?php echo e(Form::label('RWC', $rate->RWC)); ?>

			</div>
			</div>
			<div class="form-group">
			<div class="col-md-6">
			<?php echo e(Form::label('WWC', 'WWC')); ?>

			</div>
			<div class="col-md-6">
				<?php echo e(Form::label('WWC', $rate->WWC)); ?>
			...
			<div class="form-group">
			<div class="col-md-6">
			<?php echo e(Form::label('Elig', 'Elig')); ?>

			</div>
			<div class="col-md-6">
				<?php echo e(Form::label('Elig', $rate->Elig)); ?>
			...
			<div class="col-md-6">
				<?php echo e(Form::label('Description', $rate->Description)); ?>
