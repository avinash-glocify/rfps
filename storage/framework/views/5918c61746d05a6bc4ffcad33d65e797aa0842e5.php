								...
								<li class="hov-cl">
                                 ...
                                 <li class="hov-cl">
                                     ...
                                     <ul class="sub-menu-de">
                                         <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('broker/addbrokerlead')); ?>" ><i class="fa fa-users"></i>Add Leads</a></li>
                                         <li><a  href="<?php echo e(URL::to('broker/allbrokerleads')); ?>" ><i class="fa fa-users"></i>View Leads</a></li>
