                                ...
                                <div class="block-content tab-content">
                                 ...
                                 <?php if(Session::has('flash_message')): ?>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <?php echo Form::open(array('url' => 'admin/updateProfile','class'=>'form-horizontal padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' => 'multipart/form-data')); ?>
                                    ...
                                    <?php /*<div class="col-lg-8 tab-pane" id="btabs-alt-static-password">
