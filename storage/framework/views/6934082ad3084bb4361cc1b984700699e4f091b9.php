                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidingbbr sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="<?php echo e(URL::to('company/comapnyleads')); ?>">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                <!--<li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('dashboard')); ?>" href="<?php echo e(URL::to('company/dashboard')); ?>">
                                        <span class="side-add"><i class="si si-speedometer"></i>
                                        </span>
                                        <span class="sidebar-mini-hide side-add2">Dashboard</span></a>
                                </li> -->
								<li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('profile')); ?>" href="<?php echo e(URL::to('company/editCompany',[Auth::user('id')])); ?>">
                                        <span class="side-add"><i class="si si-user"></i>
                                        </span>
                                        <span class="sidebar-mini-hide side-add2">Profile</span></a>
                                </li>
								<li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('Leads')); ?>" href="<?php echo e(URL::to('company/comapnyleads')); ?>">
                                        <span class="side-add"><i class="fa fa-tasks"></i>
                                        </span>
                                        <span class="sidebar-mini-hide side-add2">Prospects  <?php if($getNotificationL!=0) { ?>(<?php echo e($getNotificationL); ?>) <?php } ?></span></a>
                                </li>
								<li class="hov-cl">
