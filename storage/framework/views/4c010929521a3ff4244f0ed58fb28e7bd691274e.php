 ...
 <!-- Page Header -->
              <?php /*  <div class="content bg-image" style="background-image: url('{{ URL::asset('admin_assets/img/photos/bg.jpg') }}');">
                ...
                <div class="content content-boxed">
                    <div class="row">						<h3>Add New Company</h3>
	...
	<div class="row" >
				...
				<?php echo e(Form::select('city',$city,null, ['class' => 'form-control'])); ?>
								...
								<div class="form-group">
                                  <!--          <div class="form-group">	 
												<?php echo e(Form::label('preferr_number_of_employee', ' Number Of Employees')); ?>				<?php echo e(Form::select('preferr_number_of_employee',$numbersOfEmployees, null, ['class' => 'form-control', 'multiple'=>'multiple','name'=>'preferr_number_of_employee[]'])); ?>
								...
								<div class="form-group">
										...
										<?php echo e(Form::select('preferr_industry',$workIN, null, ['class' => 'form-control', 'multiple'=>'multiple','name'=>'preferr_industry[]'])); ?>
