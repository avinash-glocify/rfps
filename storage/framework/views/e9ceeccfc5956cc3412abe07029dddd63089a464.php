    ...
    <div style="height:720px; width:440px; margin:40px auto;">
            ...
            <div style="padding:0 30px; border-bottom:1px solid #0096d6;">
                ...
                <aside style="margin-top:30px; line-height:25px;"> <!--
					...
					<p>Please click the following link to reset the new password. </p>
					<p>Please follow this link: <a href="<?php echo e(URL::to('admin/resetpassword/').'/'.base64_encode($id)); ?>" data-toggle="tooltip" data-placement="left" title="Log In">Click</a></p>
