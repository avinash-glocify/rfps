                            ...
                            <ul class="nav-main">
								...
								<li class="hov-cl">
								 ...
								 <li class="hov-cl">
                                     <a class="<?php echo e(classActivePath('manage-company')); ?> nav-submenu" href="javascript:void(0);" data-toggle="nav-submenu" >
                                         <span class="side-add"><i class="fa fa-users"></i></span>
                                         <span class="sidebar-mini-hide side-add2">Manage Leads<?php if($getNotificationL!=0) { ?>(<?php echo e($getNotificationL); ?>)<?php } ?></span>
                                     </a>
                                     <ul class="sub-menu-de">
										<li><a  href="<?php echo e(URL::to('admin/AllLeads')); ?>" ><i class="fa fa-users"></i>All  Leads</a></li>
                                        <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/AddLead')); ?>" ><i class="fa fa-users"></i>Add Lead</a></li>
                                 ...
                                 <li class="hov-cl">
                                     <a class="<?php echo e(classActivePath('manage-company')); ?> nav-submenu" href="javascript:void(0);" data-toggle="nav-submenu" >
										 ...
										 <?php if($getNotificationB!=0) { ?>(<?php echo e($getNotificationB); ?>)<?php } ?></span>
                                     </a>
                                     <ul class="sub-menu-de">
								  ...
								  <li class="hov-cl" >
                                     <a class="<?php echo e(classActivePath('manage-company')); ?> nav-submenu" href="javascript:void(0);" data-toggle="nav-submenu"  >
                                         <span class="side-add"><i class="fa fa-users"></i></span>
                                         <span class="sidebar-mini-hide side-add2" >Manage company  <?php if($getNotificationC!=0) { ?>(<?php echo e($getNotificationC); ?>)<?php } ?></span>
                                     </a>
                                     <ul class="sub-menu-de">
										 <li id="company"><a  href="<?php echo e(URL::to('admin/AllCompanies')); ?>" ><i class="fa fa-users"></i>All  company</a></li>
										 
                                         <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/AddCompany')); ?>" ><i class="fa fa-users"></i>Add company</a></li>
