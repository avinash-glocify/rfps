      ...
      <div class="modal-body">
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="form-group">	 
					<div class="col-lg-3">
						<?php echo e(Form::label('quote_title', 'Title')); ?>	<span class="error" style="color: red;">*</span>
					</div>
					<div class="col-lg-9">
						<?php echo e(Form::label('quote_title', @$getQuotes[0]->quote_title)); ?>
			...
			<div class="col-lg-12">
				<div class="form-group">	 
					<div class="col-lg-3">
						<?php echo e(Form::label('quote_description', 'Description')); ?><span class="error" style="color: red;">*</span>
					</div>
					<div class="col-lg-9">
						<?php echo e(Form::label('quote_description', @$getQuotes[0]->quote_description)); ?>
			...
			<div class="col-lg-12">
				<div class="form-group">	 
					<div class="col-lg-3">
						<?php echo e(Form::label('quote_attachment', 'Docs')); ?><span class="error" style="color: red;">*</span>
					</div>
					<div class="col-lg-9">
						<?php if((@$getQuotes[0]->document != '')){?>
						<a target="_blank" href="<?php echo e(URL::to('/')); ?>/quotes/<?php echo @$getQuotes[0]->document;?>">
							Click to View
						</a>
						<?php } ?>
					</div>										
			...
			<div class="col-lg-12">
				<div class="form-group">	 
					<div class="col-lg-3">
						<?php echo e(Form::label('quote_status', 'Status')); ?><span class="error" style="color: red;">*</span>
					</div>
					<div class="col-lg-9">
...
<div class="modal fade" id="sendQuote" tabindex="-1" role="dialog" aria-labelledby="favoritesModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo Form::open(array('url' => 'company/SendQuote','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'quoteform','role'=>'form','file'=>true,'enctype'=>'multipart/form-data')); ?>		
		<?php $userId = Auth::user()->id;					
		$usertype = Auth::user()->usertype;?>
		<input type="hidden" name="leadid" value="<?php echo e($leadData['id']); ?>" required>
		...
		<input type="hidden" name="reciever_id" value="<?php echo e($leadData['user_id']); ?>" required>
		<div class="row">
			<div class="col-lg-12" id="alert_message" style="display:none;"></div>
			<div class="col-lg-12">
				<div class="form-group">	 
					...
					<div class="col-lg-9">
						<?php echo e(Form::text('quote_title','',['class' => 'form-control', 'required' => 'required'])); ?>
			...
			<div class="col-lg-12">
				<div class="form-group">	 
					...
					<div class="col-lg-9">
						<?php echo e(Form::textarea('quote_description','',['class' => 'form-control', 'required' => 'required'])); ?>
