                                 ...
                                 <?php if(Session::has('flash_message')): ?>
									...
									<div class="row" >
										<table id="example" class="display" style="width:100%">
											...
											<tbody><?php $i = 1;?>
												<?php foreach($getALlBroker as $company): ?>
													...
													<tr style="background-color:#262323;color:white">
														...
														<?php endif; ?>
														<td><a href="<?php echo e(url('admin/updateBroker', ['id' => $company->id])); ?>">Update</a></td> 
														<td><a onclick="return confirm('Are you sure?')" href="<?php echo e(url('admin/DeleteBroker', ['id' => $company->id])); ?>">Delete</a></td>
														<td><a href="<?php echo e(url('admin/viewBroker', ['id' => $company->id])); ?>">View</a></td>
													</tr>
													<?php else: ?>
														<tr>
														<td><?php echo e($i++); ?></td>
