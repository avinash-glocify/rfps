                            ...
                            <ul class="nav-main">
								...
								<li class="hov-cl">
								 ...
								 <li class="hov-cl">
                                     <a class="<?php echo e(classActivePath('manage-company')); ?> nav-submenu" href="javascript:void(0);" data-toggle="nav-submenu" >
                                         <span class="side-add"><i class="fa fa-users"></i></span>
                                         <span class="sidebar-mini-hide side-add2">Manage Prospects</span>
                                     </a>
                                     <ul class="sub-menu-de">
                                 ...
                                 <li class="hov-cl">
								  ...
								  <li class="hov-cl">
                                     <a class="<?php echo e(classActivePath('manage-company')); ?> nav-submenu" href="javascript:void(0);" data-toggle="nav-submenu" >
                                         <span class="side-add"><i class="fa fa-users"></i></span>
                                         <span class="sidebar-mini-hide side-add2">Manage Providers</span>
                                     </a>
                                     <ul class="sub-menu-de">
										 <li><a  href="<?php echo e(URL::to('admin/AllCompanies')); ?>" ><i class="fa fa-users"></i>All  Providers</a></li>
                                 ...
                                 <li class="hov-cl">
                                     <a class="<?php echo e(classActivePath('manual-rates')); ?> nav-submenu" href="javascript:void(0);" data-toggle="nav-submenu" >
                                         ...
                                         <span class="sidebar-mini-hide side-add2">Industry Code</span>
                                     </a>
                                     <ul class="sub-menu-de">
