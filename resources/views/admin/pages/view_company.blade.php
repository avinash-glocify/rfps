 ...
 <!-- Page Header -->
	...
	<div class="row" >
			...
			<div class="form-group">
				...
				<div class="col-md-6">
				{{Form::label('company_name', $userData['companydetails']['company_name'])}}		
				</div>
			...
			<div class="form-group">
			           <div class="col-md-6">
					     {{Form::label('number_of_employee', 'Number Of Employees')}}	
					   </div>
					   <div class="col-md-4">
					        {{Form::select('number_of_employee',$numbersOfEmployees, $userData['companydetails']['number_of_employee'], ['class' => 'form-control',' disabled'=>' disabled'])}}
			...
			<div class="form-group">
			     <div class="col-md-6">
					     {{Form::label('response_time', 'Response Time')}}		
					   </div>
					   <div class="col-md-4">					        							
							{{Form::select('response_time',$responseTime, $userData['companydetails']['response_time'], ['class' => 'form-control',' disabled'=>' disabled'])}}							
					   </div>
			...
			<div class="form-group">
               <div class="col-md-6">
						...
						<div class="col-md-6">
						{{Form::label('website_url', $userData['companydetails']['website_url'])}}
			            </div>
			...
			<div class="form-group">
			    <div class="col-md-6">
						...
						<div class="col-md-4">
						{{Form::select('status',$status, $userData['status'], ['class' => 'form-control','disabled'=>'disabled'])}}
			            </div>
			...
			<div class="form-group">
						...
						<!--<h3><strong>What Kind of Leads do you want?</strong></h3> -->
                         <div class="col-md-6">
						{{Form::label('preferr_number_of_employee', ' Number Of Employees')}}		
						</div>
						<div class="col-md-4">
						
						{{Form::select('preferr_number_of_employee',$numbersOfEmployees, $userData['companydetails']['preferr_number_of_employee'], ['class' => 'form-control','disabled'=>'disabled' ])}}
			            </div>						
			...
			<div class="form-group">
			          <div class="col-md-6">
						...
						<div class="col-md-4">
						{{Form::select('preferr_state',$state, $userData['companydetails']['preferr_state'], ['class' => 'form-control', 'disabled'=>'disabled','multiple'=>'multiple','name'=>'preferr_industry[]'])}}
			            </div>
			...
			<div class="form-group">
			       <div class="col-md-6">
						...
						<div class="col-md-6">												
						{{Form::select('preferr_interest',$jobTittle,  $userData['companydetails']['preferr_interest'], ['class' => 'form-control', 'disabled'=>'disabled','multiple'=>'multiple','name'=>'preferr_industry[]'])}}
			            </div>
			...
			<div class="form-group">
			         <div class="col-md-6">
						...
						<div class="col-md-6">												
						{{Form::select('preferr_industry',$workIN,  $userData['companydetails']['preferr_industry'], ['class' => 'form-control','disabled'=>'disabled', 'multiple'=>'multiple','name'=>'preferr_industry[]'])}}
			            </div>
