                                 ...
                                 @if(Session::has('flash_message'))
									...
									<div class="row" >
										<table id="example" class="display" style="width:100%">
											...
											<tbody><?php $i = 1;?>
												@foreach ($getALlBroker as $company)
													...
													<tr style="background-color:#262323;color:white">
														...
														@endif
														<td><a href="{{ url('admin/updateBroker', ['id' => $company->id]) }}">Update</a></td> 
														<td><a onclick="return confirm('Are you sure?')" href="{{ url('admin/DeleteBroker', ['id' => $company->id]) }}">Delete</a></td>
														<td><a href="{{ url('admin/viewBroker', ['id' => $company->id]) }}">View</a></td>
													</tr>
													@else
														<tr>
														<td>{{ $i++}}</td>
