	...
	<nav class="navbar navbar-default">
         <div class="container">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="{{ URL::to('/') }}"><img src="{{ URL::asset('front/img/logo.png') }}" alt="NetPeo" title="netpeo"></a> 
            </div>
            ...
            <div class="row">
                    ...
                    <div class="block block-themed animated fadeIn">
                        <div class="block-header bg-primary">
                            <ul class="block-options">
                                <li>
                                    <a href="{{ URL::to('admin/forgotpass') }}">Forgot Password?</a>
                                </li>
                ...
                <span aria-hidden="true">&times;</span></button>
                            ...
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                {!! Form::open(array('url' => 'admin/login','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'loginform','role'=>'form')) !!}
