...
@section('content') 
 <section class="banner_head inner_banner">
   @if (count($errors) > 0)
         ...
         {!! Form::open(array('url' => 'company/register','class'=>'','id'=>'companyform','method' => 'post','role'=>'')) !!}
            <div class="container">
      ...
      <div class="col-md-12">
		  ...
		  {{ Form::textarea('address2','',array('placeholder' => 'Address Line Two','rows' => 1, 'cols' => 20,'id'=>'address2')) }}
      </div>
	  ...
	  {{Form::select('country',$country,null, ['class' => 'form-control','selected'])}}
      </div>
	  <div class="col-md-4">
	...
	'Arlington, Texas'=>'Arlington, Texas'	);?>
	  ...
	  <?php $number_employees=array('' => ' -- Select -- ',
						...
						'3' => '500-to 1000',
						'4' => '1000 to 5000');?>
	  {{Form::select('number_of_employee',$number_employees,null, ['class' => 'form-control'])}}
      </div>
	  <div class="col-md-4">
	  ...
	  <?php $responnse_time=array('' => ' -- Select -- ',
						...
						'3days' => '3 Days',
						'week' => '1 Week',);?>
	  {{Form::select('response_time',$responnse_time,null, ['class' => 'form-control'])}}
      </div>
      <div class="col-md-4">
      ...
      <div class="row">
	   ...
	   {{Form::label('preferr_number_of_employee', ' Number Of Employees')}}				{{Form::select('preferr_number_of_employee',$state, null, ['class' => 'form-control', 'multiple'=>'multiple','name'=>'preferr_number_of_employee[]'])}}
      </div> -->
      <div class="col-md-4 col-xs-4">
