...
<html lang="en">
    ...
    <body>
        ...
        <script src="{{ URL::asset('site_assets/js/jquery.1.11.1.min.js') }}"></script>
        <script src="{{ URL::asset('site_assets/js/bootstrap.min.js') }}"></script>
        <script src="{{ URL::asset('site_assets/js/moment.js') }}" type="text/javascript" charset="utf-8"></script>            
        <script src="{{ URL::asset('site_assets/js/daterangepicker.js') }}"></script> 
