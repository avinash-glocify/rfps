...
.autocomplete-active {background-color: DodgerBlue !important;color: #ffffff;}
	...
	<div class="row" >	
		<div id="first_form">
		{!! Form::open(array('url' => 'broker/leadRegister','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'leadform1st','role'=>'form','enctype'=>'multipart/form-data')) !!}
		
		
		<div class="row">
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('first_name', 'First Name')}}	<span class="error" style="color: red;">*</span>			
				{{Form::text('first_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div> 
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('last_name', 'Last Name')}}<span class="error" style="color: red;">*</span>			
				{{Form::text('last_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('email', 'Email')}}<span class="error" style="color: red;">*</span>
				{{Form::email('email', '',['class' => 'form-control', 'required' => 'required'])}}
			</div>
			</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('company_name', 'Company Name')}}	<span class="error" style="color: red;">*</span>	
				{{Form::text('company_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('phone_number', 'Phone Number')}}	<span class="error" style="color: red;">*</span>		
		...
		<div class="col-lg-6">
		<div class="form-group">
				   {{Form::label('job_title', 'Job Title :')}}	<span class="error" style="color: red;">*</span>			
				   {{Form::select('job_title',$jobTittle, null, ['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
				   {{Form::label('work_indstry', 'Industry you work in:')}}<span class="error" style="color: red;">*</span>				
				   {{Form::select('work_indstry',$workIN, null, ['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
				   {{Form::label('country', 'Country')}}<span class="error" style="color: red;">*</span>				
				   {{Form::select('country',$country, null, ['class' => 'form-control', 'required' => 'required'])}}
		</div>
		<div class="form-group">
				   {{Form::label('state', 'State')}}	<span class="error" style="color: red;">*</span>	
					{{Form::select('state',$state, null, ['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
				   {{Form::label('city', 'City')}}	<span class="error" style="color: red;">*</span>	
		...
		<div class="col-lg-6">
		 <div class="form-group">
			{{Form::label('total_employee', 'Number Of Employees')}}	<span class="error" style="color: red;">*</span>			
			{{Form::number('total_employee','',['class' => 'form-control', 'required' => 'required'])}}
		</div> 
		</div>
		</div>
		<div class="row">
		...
		{!! Form::open(array('url' => 'broker/request_for_proposal','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'request_for_proposalform','role'=>'form')) !!}
		<div class="row">
		<div class="col-sm-12 col-lg-12">
		...
		<div class="col-sm-12 col-lg-12">
		<div class="form-group">	 
				{{Form::label('legal_name_dba', 'Legal Business Name and DBA:')}}	<span class="error" style="color: red;">*</span>		
				{{Form::text('legal_name_dba','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('Street_Address', 'Street Address:')}}	<span class="error" style="color: red;">*</span>		
				{{Form::text('Street_Address','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('city_state_zip', 'City/State/Zip:')}}<span class="error" style="color: red;">*</span>			
				{{Form::text('city_state_zip','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('Phone', 'Phone:')}}		<span class="error" style="color: red;">*</span>	
				{{Form::text('Phone','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('Fax', 'Fax:')}}		<span class="error" style="color: red;">*</span>	
				{{Form::text('Fax','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('Contact_Name', 'Contact Name: :')}}	<span class="error" style="color: red;">*</span>		
				{{Form::text('Contact_Name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('Title', 'Title: :')}}	<span class="error" style="color: red;">*</span>		
				{{Form::text('Title','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('Industry_desc', 'Industry (description of business):')}}		<span class="error" style="color: red;">*</span>	
				{{Form::text('Industry_desc','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('Fed_Tax_id', 'Fed Tax ID #:')}}	<span class="error" style="color: red;">*</span>		
				{{Form::text('Fed_Tax_id','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('Years_inBusiness', 'Years in Business: ')}}		<span class="error" style="color: red;">*</span>	
				{{Form::text('Years_inBusiness','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-sm-6 col-lg-6">
		<div class="form-group">	 
				{{Form::label('SIC_Code', 'SIC Code:')}}	<span class="error" style="color: red;">*</span>		
				{{Form::text('SIC_Code','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		</div>
...
<p>Fill out table below or simply attach workers’ compensation declaration page/accord form for desired Information</p>
		...
		<strong>Payroll Frequency:</strong><br />
				{{Form::checkbox('PayrollFrequency[]','Weekly', false)}}
				{{Form::label('PayrollFrequency', 'Weekly')}}	<br />
				
				{{Form::checkbox('PayrollFrequency[]','Bi-weekly', false)}}
				{{Form::label('PayrollFrequency', 'Bi-weekly')}}	<br />
				
				{{Form::checkbox('PayrollFrequency[]','Semi-monthly', false)}}
				{{Form::label('PayrollFrequency', 'Semi-monthly')}}	<br />
				
				{{Form::checkbox('PayrollFrequency[]','Monthly', false)}}
				{{Form::label('PayrollFrequency', 'Monthly')}}	<br />
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('CurrentCostPayroll', 'Current Cost of Payroll:')}}			
				{{Form::text('CurrentCostPayroll','',['class' => 'form-control', 'required' => 'required','placeholder'=>'payroll service, internal costs, etc...'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('CurrentofHR', 'Current Cost of HR:')}}			
				{{Form::text('CurrentofHR','',['class' => 'form-control', 'required' => 'required','placeholder'=>'PEO, HR consulting, internal costs, etc...'])}}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('CurrentStateUnemployment', 'Current State Unemployment Rate:')}}			
				{{Form::text('CurrentStateUnemployment','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('WorkersCompensationModifier', 'Workers Compensation Modifier:')}}			
				{{Form::text('WorkersCompensationModifier','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('DesiredStartDate', 'Desired Start Date:')}}			
				{{Form::text('DesiredStartDate','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-12">
		...
		<div class="form-group">
					...
					{{Form::label('EmployerCurrentlyBenefits', 'yes')}}
					{{Form::radio('EmployerCurrentlyBenefits', 'yes' ,'false')}}<br />
					{{Form::label('EmployerCurrentlyBenefits', 'no')}}
					{{Form::radio('EmployerCurrentlyBenefits', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('NetPEOHRBenefits', 'yes')}}
					{{Form::radio('NetPEOHRBenefits', 'yes' ,'false')}}<br />
					{{Form::label('NetPEOHRBenefits', 'no')}}
					{{Form::radio('NetPEOHRBenefits', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
					<strong>Does Employer Currently have a 401(k)? </strong><br />
					{{Form::label('EmployerCurrently401', 'yes')}}
					{{Form::radio('EmployerCurrently401', 'yes' ,'false')}}<br />
					{{Form::label('EmployerCurrently401', 'no')}}
					{{Form::radio('EmployerCurrently401', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
					<strong>Does Employer Wish to Offer NetPEO HR 401(k)? </strong><br />
					{{Form::label('NetPEOHR401', 'yes')}}
					{{Form::radio('NetPEOHR401', 'yes' ,'false')}}<br />
					{{Form::label('NetPEOHR401', 'no')}}
					{{Form::radio('NetPEOHR401', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-12">
...
<li> PEO Billing Statement (if current PEO client)
		...
		{!! Form::open(array('url' => 'broker/request_for_compansation','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'request_for_compansation','role'=>'form','enctype'=>'multipart/form-data')) !!}
		<div class="col-lg-12">
		...
		<div class="form-group">
		  {!! Form::label('acc_agency_and_address','AGENCY NAME AND ADDRESS') !!}
		  {!! Form::textarea('acc_agency_and_address',null,['class'=>'form-control','rows' => 4,]) !!}
		</div>
		</div>
		<input type="hidden" id="lead_WORKERSCOMPENSATION_id" name="lead_WORKERSCOMPENSATION_id">
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_producer_name', 'PRODUCER NAME:')}}			
				{{Form::text('acc_producer_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_repersantive_name', 'CS REPRESENTATIVE NAME:')}}			
				{{Form::text('acc_repersantive_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_agency_office_name', 'OFFICE PHONE (A/C, No, Ext):')}}			
				{{Form::text('acc_agency_office_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_agency_mobile_name', 'MOBILE PHONE:')}}			
				{{Form::text('acc_agency_mobile_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_agency_fax_no', 'FAX(A/C, No):')}}			
				{{Form::text('acc_agency_fax_no','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_agency_email', 'E-MAIL ADDRESS:')}}			
				{{Form::text('acc_agency_email','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_agency_code', 'CODE:')}}			
				{{Form::text('acc_agency_code','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_agency_sub_code', 'SUB CODE:')}}			
				{{Form::text('acc_agency_sub_code','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_agency_customer_id', 'AGENCY CUSTOMER ID:')}}			
				{{Form::text('acc_agency_customer_id','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_company', 'Company')}}			
				{{Form::text('acc_company','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_underwriter', 'UNDERWRITER')}}			
				{{Form::text('acc_underwriter','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_applicant_name', 'APPLICANT NAME:')}}			
				{{Form::text('acc_applicant_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_office_phone', 'OFFICE PHONE:')}}			
				{{Form::text('acc_office_phone','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_mobile_phone', 'MOBILE PHONE:')}}			
				{{Form::text('acc_mobile_phone','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		...
		<div class="form-group">
		  {!! Form::label('acc_mailing_address','MAILING ADDRESS (including ZIP  + 4 or Canadian Postal Code)') !!}
		  {!! Form::textarea('acc_mailing_address',null,['class'=>'form-control','rows' => 4,]) !!}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_yrs_in_bus', 'YRS IN BUS:')}}			
				{{Form::text('acc_yrs_in_bus','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		<div class="form-group">	 
				{{Form::label('acc_sic', 'SIC:')}}			
				{{Form::text('acc_sic','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_naics', 'NAICS:')}}			
				{{Form::text('acc_naics','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_web_adderss', 'WEBSITE ADDRESS:')}}			
				{{Form::text('acc_web_adderss','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_company_email_address', 'E-MAIL ADDRESS:')}}			
				{{Form::text('acc_company_email_address','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		
		<div class="form-group">	 
				{{Form::label('acc_company_credit_bureau_name', 'CREDIT BUREAU NAME:')}}			
				{{Form::text('acc_company_credit_bureau_name','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		...
		<div class="col-lg-6">
		<div class="form-group">
				{{Form::checkbox('company_etra_details[]','SOLE PROPRIETOR', false)}}
				{{Form::label('company_etra_details', 'SOLE PROPRIETOR')}}	<br />
				
				{{Form::checkbox('company_etra_details[]','PARTNERSHIP', false)}}
				{{Form::label('company_etra_details', 'PARTNERSHIP')}}	<br />
				
				{{Form::checkbox('company_etra_details[]','SUBCHAPTER "S" CORP', false)}}
				{{Form::label('company_etra_details', 'SUBCHAPTER "S" CORP')}}	<br />
				
				{{Form::checkbox('company_etra_details[]','LLC', false)}}
				{{Form::label('company_etra_details', 'LLC')}}	<br />
				
				{{Form::checkbox('company_etra_details[]','JOINT VENTURE', false)}}
				{{Form::label('company_etra_details', 'JOINT VENTURE')}}	<br />
				
				{{Form::checkbox('company_etra_details[]','TRUST', false)}}
				{{Form::label('company_etra_details', 'TRUST')}}	<br />
				
				{{Form::checkbox('company_etra_details[]','OTHER', false)}}
				{{Form::label('company_etra_details', 'OTHER')}}	<br />
				
				{{Form::checkbox('company_etra_details[]','UNINCORPORATED ASSOCIATION', false)}}
				{{Form::label('company_etra_details', 'UNINCORPORATED ASSOCIATION')}}	<br />
					
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_company_id_number', 'ID NUMBER:')}}			
				{{Form::text('acc_company_id_number','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_fedral_no', 'FEDERAL EMPLOYER ID NUMBER')}}			
				{{Form::text('acc_fedral_no','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_ncci_risk_no', 'NCCI RISK ID NUMBER')}}			
				{{Form::text('acc_ncci_risk_no','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_other_bureau_id', 'OTHER RATING BUREAU ID OR STATE EMPLOYER REGISTRATION NUMBER')}}			
				{{Form::text('acc_other_bureau_id','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		...
		<strong>STATUS OF SUBMISSION</strong><br />
				{{Form::checkbox('acc_status_submission[]','QUOTE', false)}}
				{{Form::label('acc_status_submission', 'QUOTE')}}	<br />
				
				{{Form::checkbox('acc_status_submission[]','ISSUE POLICY', false)}}
				{{Form::label('acc_status_submission', 'ISSUE POLICY')}}	<br />
				
				{{Form::checkbox('acc_status_submission[]','BOUND (Give date and/or attach copy)', false)}}
				{{Form::label('acc_status_submission', 'BOUND (Give date and/or attach copy)')}}	<br />
				
				{{Form::checkbox('acc_status_submission[]','ASSIGNED RISK (Attach ACORD 133)', false)}}
				{{Form::label('acc_status_submission', 'ASSIGNED RISK (Attach ACORD 133)')}}	<br />
		...
		<strong>BILLING PLAN</strong><br />
				{{Form::checkbox('acc_billing_plan[]','AGENCY BILL', false)}}
				{{Form::label('acc_billing_plan', 'AGENCY BILL')}}	<br />
				
				{{Form::checkbox('acc_billing_plan[]','DIRECT BILL', false)}}
				{{Form::label('acc_billing_plan', 'DIRECT BILL')}}	<br />
		...
		<strong>PAYMENT PLAN</strong><br />
				{{Form::checkbox('acc_payment_plan[]','ANNUAL', false)}}
				{{Form::label('acc_payment_plan', 'ANNUAL')}}	<br />
				
				{{Form::checkbox('acc_payment_plan[]','SEMI-ANNUAL', false)}}
				{{Form::label('acc_payment_plan', 'SEMI-ANNUAL')}}	<br />
				
				{{Form::checkbox('acc_payment_plan[]','QUARTERLY', false)}}
				{{Form::label('acc_payment_plan', 'QUARTERLY')}}	<br />
		...
		<strong>AUDIT </strong><br />
				{{Form::checkbox('acc_audit[]','AT EXPIRATION', false)}}
				{{Form::label('acc_audit', 'AT EXPIRATION')}}	<br />
				
				{{Form::checkbox('acc_audit[]','SEMI-ANNUAL', false)}}
				{{Form::label('acc_audit', 'SEMI-ANNUAL')}}	<br />
				
				{{Form::checkbox('acc_audit[]','QUARTERLY', false)}}
				{{Form::label('acc_audit', 'QUARTERLY')}}	<br />
				
				{{Form::checkbox('acc_audit[]','MONTHLY', false)}}
				{{Form::label('acc_audit', 'MONTHLY')}}	<br />
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_PROPOSED_eff_date', 'PROPOSED EFF DATE')}}			
				{{Form::text('acc_PROPOSED_eff_date','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_PROPOSED_exp_date', 'PROPOSED EXP DATE')}}			
				{{Form::text('acc_PROPOSED_exp_date','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_annivertsary_date', 'NORMAL ANNIVERSARY RATING DATE')}}			
				{{Form::text('acc_annivertsary_date','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_retro_plan', 'RETRO PLAN')}}			
				{{Form::text('acc_retro_plan','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		...
		<div class="form-group">
					...
					{{Form::label('acc_PARTICIPATING', 'PARTICIPATING')}}
					{{Form::radio('acc_PARTICIPATING', 'PARTICIPATING' ,'false')}}<br />
					{{Form::label('acc_PARTICIPATING', 'NON-PARTICIPATING')}}
					{{Form::radio('acc_PARTICIPATING', 'NON-PARTICIPATING', 'false')}}
		</div>
		</div>
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_WORKERSCOMPENSATION_state', 'PART 1 - WORKERSCOMPENSATION (States)')}}			
				{{Form::text('acc_WORKERSCOMPENSATION_state','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		...
		<div class="form-group">	
            <h6>PART 2 - EMPLOYER'S LIABILITY</h6>		
				<div class="col-lg-4">
				{{Form::text('acc_par2_liblaty_each_accident','',['class' => 'form-control', 'required' => 'required','placeholder'=>'EACH ACCIDENT'])}}
				</div>
				<div class="col-lg-4">
				{{Form::text('acc_par2_liblaty_diseases_pol','',['class' => 'form-control', 'required' => 'required','placeholder'=>'DISEASE-POLICY LIMIT '])}}
				</div>
				<div class="col-lg-4">
				{{Form::text('acc_par2_liblaty_diseses_each_emp','',['class' => 'form-control', 'required' => 'required','placeholder'=>'DISEASE-EACH EMPLOYEE'])}}
				</div>
		</div>
		</div>
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_OTHERSTATES_ins', 'PART 3 - OTHERSTATES INS')}}			
				{{Form::text('acc_OTHERSTATES_ins','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_AMOUNT_na_wi', 'AMOUNT / %(N / A in WI)')}}			
				{{Form::text('acc_AMOUNT_na_wi','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		<div class="col-lg-6">
		<div class="form-group">
		<strong>DEDUCTIBLES (N / A in WI) </strong><br />
				{{Form::checkbox('acc_DEDUCTIBLES_wi[]','MEDICAL', false)}}
				{{Form::label('acc_DEDUCTIBLES_wi', 'MEDICAL')}}	<br />
				
				{{Form::checkbox('acc_DEDUCTIBLES_wi[]','INDEMNITY', false)}}
				{{Form::label('acc_DEDUCTIBLES_wi', 'INDEMNITY')}}	<br />
		...
		<strong>OTHER COVERAGES</strong><br />
				{{Form::checkbox('acc_other_coverage[]','U.S.L. & H', false)}}
				{{Form::label('acc_other_coverage', 'U.S.L. & H')}}	<br />
				
				{{Form::checkbox('acc_other_coverage[]','VOLUNTARY COMP', false)}}
				{{Form::label('acc_other_coverage', 'VOLUNTARY COMP')}}	<br />
				
				{{Form::checkbox('acc_other_coverage[]','FOREIGN COV', false)}}
				{{Form::label('acc_other_coverage', 'FOREIGN COV')}}	<br />
				
				{{Form::checkbox('acc_other_coverage[]','MANAGED CARE OPTION', false)}}
				{{Form::label('acc_other_coverage', 'MANAGED CARE OPTION')}}	<br />
		...
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc_DIVIDEND_safty_group', 'DIVIDEND PLAN/SAFETY GROUP')}}			
				{{Form::text('acc_DIVIDEND_safty_group','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		
		<div class="col-lg-6">
		<div class="form-group">	 
				{{Form::label('acc__additional_company_issuie', 'ADDITIONAL COMPANY INFORMATION')}}			
				{{Form::text('acc__additional_company_issuie','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		
		<div class="col-lg-12">
		<div class="form-group">	 
				{{Form::label('acc__specify_additional_coverage', 'SPECIFY ADDITIONAL COVERAGES / ENDORSEMENTS (Attach ACORD 101, Additional Remarks Schedule, if more space is required)')}}			
				{{Form::text('acc__specify_additional_coverage','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div> 
		<div class="col-lg-12">
		...
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('acc_total_estimate_annual', 'TOTAL ESTIMATED ANNUAL PREMIUM - ALL STATES')}}			
				{{Form::text('acc_total_estimate_annual','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('acc_total_minimum_premium', 'TOTAL MINIMUM PREMIUM ALL STATES')}}			
				{{Form::text('acc_total_minimum_premium','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('acc_total_deposite_premium', 'TOTAL DEPOSIT PREMIUM ALL STATES')}}			
				{{Form::text('acc_total_deposite_premium','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		</div>
		<div class="col-lg-12">
...
Exclusions in Missouri must meet the requirements of Section 287.090 RSMo. </p>
		...
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('acc_STATERATINGSHEET', 'STATE RATING SHEET #')}}			
				{{Form::text('acc_STATERATINGSHEET','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-3">
		<div class="form-group">	 
				{{Form::label('acc_SHEETS', 'SHEETS')}}			
				{{Form::text('acc_SHEETS','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('acc_AGENCYCUSTOMERid', 'AGENCY CUSTOMER ID:')}}			
				{{Form::text('acc_AGENCYCUSTOMERid','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		</div>
		...
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('acc_RATINGINFORMATIONstate', 'RATING INFORMATION - STATE:')}}			
				{{Form::text('acc_RATINGINFORMATIONstate','',['class' => 'form-control', 'required' => 'required'])}}
		</div>
		</div>
		<div class="col-lg-12"> 
		<div class="col-lg-1">LOC #</div>
		...
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('PREMIUM_total_ANNUAL_P', 'TOTAL ESTIMATED ANNUAL PREMIUM')}}			
				{{Form::text('PREMIUM_total_ANNUAL_P','',['class' => 'form-control', 'required' => 'required','placeholder'=>'$'])}}
		</div>
		</div>
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('PREMIUM_MINIMUM_P', 'MINIMUM PREMIUM ')}}			
				{{Form::text('PREMIUM_MINIMUM_P','',['class' => 'form-control', 'required' => 'required','placeholder'=>'$'])}}
		</div>
		</div>
		<div class="col-lg-4">
		<div class="form-group">	 
				{{Form::label('PREMIUM_DEPOSIT_P', 'DEPOSIT PREMIUM')}}			
				{{Form::text('PREMIUM_DEPOSIT_P','',['class' => 'form-control', 'required' => 'required','placeholder'=>'$'])}}
		</div>
		</div>
		</div>
		...
		<div class="form-group">
		  {!! Form::label('acc_remarks','REMARKS (ACORD 101, Additional Remarks Schedule, may be attached if more space is required)') !!}
		  {!! Form::textarea('acc_remarks',null,['class'=>'form-control','rows' => 4,]) !!}
		</div>
		</div>
		<div class="col-lg-12">
		...
		<div class="form-group">
		  ...
		  {!! Form::textarea('acc_nature_description',null,['class'=>'form-control','rows' => 4,]) !!}
		</div>
		</div>
		<div class="col-lg-12">
		...
		<div class="form-group">
					...
					{{Form::label('acc_watercraft_yes_no', 'yes')}}
					{{Form::radio('acc_watercraft_yes_no', 'yes' ,'false')}}<br />
					{{Form::label('acc_watercraft_yes_no', 'no')}}
					{{Form::radio('acc_watercraft_yes_no', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_DISCONTINUED_OPERATIONS', 'yes')}}
					{{Form::radio('acc_DISCONTINUED_OPERATIONS', 'yes' ,'false')}}<br />
					{{Form::label('acc_DISCONTINUED_OPERATIONS', 'no')}}
					{{Form::radio('acc_DISCONTINUED_OPERATIONS', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
					<strong> 3). ANY WORK PERFORMED UNDERGROUND OR ABOVE 15 FEET?</strong><br />
					{{Form::label('acc_above_under15', 'yes')}}
					{{Form::radio('acc_above_under15', 'yes' ,'false')}}<br />
					{{Form::label('acc_above_under15', 'no')}}
					{{Form::radio('acc_above_under15', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_BRIDGE_over_water', 'yes')}}
					{{Form::radio('acc_BRIDGE_over_water', 'yes' ,'false')}}<br />
					{{Form::label('acc_BRIDGE_over_water', 'no')}}
					{{Form::radio('acc_BRIDGE_over_water', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_any_other_busness', 'yes')}}
					{{Form::radio('acc_any_other_busness', 'yes' ,'false')}}<br />
					{{Form::label('acc_any_other_busness', 'no')}}
					{{Form::radio('acc_any_other_busness', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_sub_contracted', 'yes')}}
					{{Form::radio('acc_sub_contracted', 'yes' ,'false')}}<br />
					{{Form::label('acc_sub_contracted', 'no')}}
					{{Form::radio('acc_sub_contracted', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
					...
					{{Form::label('acc_without_insurance', 'yes')}}
					{{Form::radio('acc_without_insurance', 'yes' ,'false')}}<br />
					{{Form::label('acc_without_insurance', 'no')}}
					{{Form::radio('acc_without_insurance', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
					<strong> 8). IS A WRITTEN SAFETY PROGRAM IN OPERATION?</strong><br />
					{{Form::label('acc_writen_safty_program', 'yes')}}
					{{Form::radio('acc_writen_safty_program', 'yes' ,'false')}}<br />
					{{Form::label('acc_writen_safty_program', 'no')}}
					{{Form::radio('acc_writen_safty_program', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_group_transportation', 'yes')}}
					{{Form::radio('acc_group_transportation', 'yes' ,'false')}}<br />
					{{Form::label('acc_group_transportation', 'no')}}
					{{Form::radio('acc_group_transportation', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_employees_under16', 'yes')}}
					{{Form::radio('acc_employees_under16', 'yes' ,'false')}}<br />
					{{Form::label('acc_employees_under16', 'no')}}
					{{Form::radio('acc_employees_under16', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_seasonal_employee', 'yes')}}
					{{Form::radio('acc_seasonal_employee', 'yes' ,'false')}}<br />
					{{Form::label('acc_seasonal_employee', 'no')}}
					{{Form::radio('acc_seasonal_employee', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
					<strong> 12).IS THERE ANY VOLUNTEER OR DONATED LABOR?  (If "YES", please specify)</strong><br />
					{{Form::label('acc_volunteer_donated', 'yes')}}
					{{Form::radio('acc_volunteer_donated', 'yes' ,'false')}}<br />
					{{Form::label('acc_volunteer_donated', 'no')}}
					{{Form::radio('acc_volunteer_donated', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_employees_handicaped', 'yes')}}
					{{Form::radio('acc_employees_handicaped', 'yes' ,'false')}}<br />
					{{Form::label('acc_employees_handicaped', 'no')}}
					{{Form::radio('acc_employees_handicaped', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_employees_travel_out_state', 'yes')}}
					{{Form::radio('acc_employees_travel_out_state', 'yes' ,'false')}}<br />
					{{Form::label('acc_employees_travel_out_state', 'no')}}
					{{Form::radio('acc_employees_travel_out_state', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_atheletic_team', 'yes')}}
					{{Form::radio('acc_atheletic_team', 'yes' ,'false')}}<br />
					{{Form::label('acc_atheletic_team', 'no')}}
					{{Form::radio('acc_atheletic_team', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_physical_required', 'yes')}}
					{{Form::radio('acc_physical_required', 'yes' ,'false')}}<br />
					{{Form::label('acc_physical_required', 'no')}}
					{{Form::radio('acc_physical_required', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_other_insurance', 'yes')}}
					{{Form::radio('acc_other_insurance', 'yes' ,'false')}}<br />
					{{Form::label('acc_other_insurance', 'no')}}
					{{Form::radio('acc_other_insurance', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_prior_coverage', 'yes')}}
					{{Form::radio('acc_prior_coverage', 'yes' ,'false')}}<br />
					{{Form::label('acc_prior_coverage', 'no')}}
					{{Form::radio('acc_prior_coverage', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_employees_health_plan', 'yes')}}
					{{Form::radio('acc_employees_health_plan', 'yes' ,'false')}}<br />
					{{Form::label('acc_employees_health_plan', 'no')}}
					{{Form::radio('acc_employees_health_plan', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_employees_buisness_subdieries', 'yes')}}
					{{Form::radio('acc_employees_buisness_subdieries', 'yes' ,'false')}}<br />
					{{Form::label('acc_employees_buisness_subdieries', 'no')}}
					{{Form::radio('acc_employees_buisness_subdieries', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-6">
		<div class="form-group">
					<strong> 21).DO YOU LEASE EMPLOYEES TO OR FROM OTHER EMPLOYERS?</strong><br />
					{{Form::label('acc_employees_lease', 'yes')}}
					{{Form::radio('acc_employees_lease', 'yes' ,'false')}}<br />
					{{Form::label('acc_employees_lease', 'no')}}
					{{Form::radio('acc_employees_lease', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_employees_PREDOMINANTLY_work', 'yes')}}
					{{Form::radio('acc_employees_PREDOMINANTLY_work', 'yes' ,'false')}}<br />
					{{Form::label('acc_employees_PREDOMINANTLY_work', 'no')}}
					{{Form::radio('acc_employees_PREDOMINANTLY_work', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_tax_liens_5hours', 'yes')}}
					{{Form::radio('acc_tax_liens_5hours', 'yes' ,'false')}}<br />
					{{Form::label('acc_tax_liens_5hours', 'no')}}
					{{Form::radio('acc_tax_liens_5hours', 'no', 'false')}}
		</div>
		</div>
		...
		<div class="form-group">
					...
					{{Form::label('acc_UNDISPUTED_unpaid_work', 'yes')}}
					{{Form::radio('acc_UNDISPUTED_unpaid_work', 'yes' ,'false')}}<br />
					{{Form::label('acc_UNDISPUTED_unpaid_work', 'no')}}
					{{Form::radio('acc_UNDISPUTED_unpaid_work', 'no', 'false')}}
		</div>
		</div>
		<div class="col-lg-6">
