...
<body>			
	...
	<thead>
		<tr>
			<th>{{Form::label('legal_name_dba', 'Legal Business Name and DBA:')}}</th>
			<th>{{Form::label('legal_name_dba', $Questionnaire['legal_name_dba'])}}	</th>
			<th>{{Form::label('Street_Address', 'Street Address:')}}</th>
			<th>{{Form::label('Street_Address', $Questionnaire['Street_Address'])}}</th>                
		</tr>
	</thead>
	<tbody>
		<tr>
			<th>{{Form::label('city_state_zip', 'City/State/Zip:')}}</th>
			<th>{{Form::label('city_state_zip', $Questionnaire['city_state_zip'])}}	</th>
			<th>{{Form::label('Phone', 'Phone:')}}</th>
			<th>{{Form::label('Phone', $Questionnaire['Phone'])}}</th>
		</tr>
		<tr>
			<th>{{Form::label('Fax', 'Fax:')}}</th>
			<th>{{Form::label('Fax', $Questionnaire['Fax'])}}	</th>
			<th>{{Form::label('Contact_Name', 'Contact Name:')}}</th>
			<th>{{Form::label('Contact_Name', $Questionnaire['Contact_Name'])}}</th>
		</tr>
		<tr>
			<th>{{Form::label('Title', 'Title:')}}</th>
			<th>{{Form::label('Title', $Questionnaire['Title'])}}	</th>
			<th>{{Form::label('Industry_desc', 'Industry (description of business):')}}</th>
			<th>{{Form::label('Industry_desc', $Questionnaire['Industry_desc'])}}</th>
		</tr>
		<tr>
			<th>{{Form::label('Fed_Tax_id', 'Fed Tax ID #:')}}</th>
			<th>{{Form::label('Fed_Tax_id', $Questionnaire['Fed_Tax_id'])}}	</th>
			<th>{{Form::label('Years_inBusiness', 'Years in Business:')}}</th>
			<th>{{Form::label('Years_inBusiness', $Questionnaire['Years_inBusiness'])}}</th>
		</tr>
		<tr>
			<th>{{Form::label('SIC_Code', 'SIC Code:')}}</th>
			<th>{{Form::label('SIC_Code', $Questionnaire['SIC_Code'])}}	</th>
			<th>{{Form::label('PayrollFrequency', 'Payroll Frequency:')}}</th>
			<th>{{Form::label('PayrollFrequency', $Questionnaire['PayrollFrequency'])}}</th>
		</tr>
		<tr>
			<th>{{Form::label('CurrentCostPayroll', 'Current Cost of Payroll:')}}</th>
			<th>{{Form::label('CurrentCostPayroll', $Questionnaire['CurrentCostPayroll'])}}	</th>
			<th>{{Form::label('CurrentofHR', 'Current Cost of HR:')}}</th>
			<th>{{Form::label('CurrentofHR', $Questionnaire['CurrentofHR'])}}</th>
		</tr>			
		<tr>
			<th>{{Form::label('CurrentStateUnemployment', 'Current State Unemployment Rate:')}}</th>
			<th>{{Form::label('CurrentStateUnemployment', $Questionnaire['CurrentStateUnemployment'])}}	</th>
			<th>{{Form::label('WorkersCompensationModifier', 'Workers Compensation Modifier:')}}</th>
			<th>{{Form::label('WorkersCompensationModifier', $Questionnaire['WorkersCompensationModifier'])}}</th>
		</tr>
		<tr>
			<th>{{Form::label('DesiredStartDate', 'Desired Start Date:')}}</th>
			<th>{{Form::label('DesiredStartDate', $Questionnaire['DesiredStartDate'])}}	</th>
			<th>{{Form::label('EmployerCurrentlyBenefits', 'Does Employer Currently have Benefits?')}}</th>
			<th>{{Form::label('EmployerCurrentlyBenefits', $Questionnaire['EmployerCurrentlyBenefits'])}}</th>
		</tr>			
		<tr>
			<th>{{Form::label('NetPEOHRBenefits', 'Does Employer Wish to Offer NetPEO HR Benefits?')}}</th>
			<th>{{Form::label('NetPEOHRBenefits', $Questionnaire['NetPEOHRBenefits'])}}	</th>
			<th>{{Form::label('EmployerCurrently401', 'Does Employer Currently have a 401(k)?')}}</th>
			<th>{{Form::label('EmployerCurrently401', $Questionnaire['EmployerCurrently401'])}}</th>
		</tr>			
		<tr>
			<th>{{Form::label('NetPEOHR401', 'Does Employer Wish to Offer NetPEO HR 401(k)?')}}</th>
			<th>{{Form::label('NetPEOHR401', $Questionnaire['NetPEOHR401'])}}	</th>
			<th>&nbsp;</th>
			<th>&nbsp;</th>
		</tr>
	</tbody>
	...
	<tr>
		<th>{{Form::label('acc_par2_liblaty_diseases_pol', 'DISEASE-POLICY LIMIT:')}}</th>
		<th><?php echo $Compensation_data['acc_par2_liblaty_diseases_pol'] ? $Compensation_data['acc_par2_liblaty_diseases_pol'] : "&nbsp;" ;?></th>
		<th>{{Form::label('acc_par2_liblaty_diseses_each_emp', 'DISEASE-EACH EMPLOYEE:')}}</th>
		<th><?php echo $Compensation_data['acc_par2_liblaty_diseses_each_emp'] ? @$Compensation_data['acc_par2_liblaty_diseses_each_emp'] : "&nbsp;";?></th>
	</tr>
	<tr>
		<th>{{Form::label('acc_DIVIDEND_safty_group', 'DIVIDEND PLAN/SAFETY GROUP:')}}</th>
		<th><?php echo $Compensation_data['acc_DIVIDEND_safty_group'] ? $Compensation_data['acc_DIVIDEND_safty_group'] : "&nbsp;" ;?></th>
		<th>{{Form::label('acc__additional_company_issuie', 'ADDITIONAL COMPANY INFORMATION:')}}</th>
		<th><?php echo $Compensation_data['acc__additional_company_issuie'] ? @$Compensation_data['acc__additional_company_issuie'] : "&nbsp;";?></th>
	</tr>
	<tr>
		<th>{{Form::label('acc__specify_additional_coverage', 'SPECIFY ADDITIONAL COVERAGES / ENDORSEMENTS (Attach ACORD 101, Additional Remarks Schedule, if more space is required):')}}</th>
