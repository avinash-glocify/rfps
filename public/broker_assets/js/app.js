...
var App = function() {
    ...
    var uiHelperSlick = function(){
        ...
        jQuery('.js-slider').each(function(){
            ...
            var $sliderAuto         = $slider.data('slider-autoplay') ? $slider.data('slider-autoplay') : true;
            var $slidercenterMode    = $slider.data('slider-center-mode') ? $slider.data('slider-center-mode') : true;
            var $slidercssEase    = $slider.data('slider-css-ease') ? $slider.data('slider-css-ease') : 'linear';
            var $slidervariableWidth    = $slider.data('slider-variable-Width') ? $slider.data('slider-variable-Width') : true;
            var $sliderAutoSpeed    = $slider.data('slider-autoplay-speed') ? $slider.data('slider-autoplay-speed') : 3000;
            var $sliderSpeed    = $slider.data('slider-speed') ? $slider.data('slider-speed') : 9000;
